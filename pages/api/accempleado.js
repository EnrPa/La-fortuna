...
export default async function handler(req, res) {
    ...
    try {
      ...
      await poolConnection.query(`UPDATE Empleado SET Nombre = '${body.nombre}', RUT = '${body.rut}', Telefono = '${body.telefono}', Direccion = '${body.direccion}', Salario_Base = '${body.salario}' WHERE ID_Empleado=${body.id}`);
